...
```
Intenção → Comportamento → Prova → Execução → Aprendizado
```
...
- **ValueTracks**: Fluxos que entregam valor direto ao usuário
- **SupportTracks**: Fluxos que suportam a entrega de valor
